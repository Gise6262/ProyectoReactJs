## Tienda de juegos SQUAD GAMERS

Este es un proyecto de ecommerce básico que se utiliza para el curso de React. La aplicación permite ver una lista de juegos de variadas modalidades y realizar compras en línea. Los juegos y las órdenes de compra se almacenan en Firebase.
