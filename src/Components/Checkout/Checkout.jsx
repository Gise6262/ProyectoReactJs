        ...
        <div>
            ...
            <form onSubmit={manejadorFormulario} className="formulario">
                ...
                <div className="form-group">
                    ...
                    <input type="email" required  value={emailConfirmacion} onChange={(e) => setEmailConfirmacion(e.target.value)} />
                </div>

                {error && <p style={{ color: "red" }}> {error} </p>}
                <button className="finCompra" type="submit"> Finalizar Compra </button>
            </form>
            {
                ordenId && (
